...
> 이전 저점을 찾을 수 있나
>
> 찾으면, 이전 저점 이전으로는 잘라버리고, 이후로 저점 찾기 limit_line=0.7
>
> 1. 차트를 긁어온다.
> 2. 첫저점을 잡는다.  (정확도 높게)
>    1. limit_line 을 1부터 시작해서 저점이 하나라도 생길때까지 감소시킨다.
> 3. 첫저점 이전으로 자른다.
>    1. 첫저점 예측의 가장 최근 데이터까지 자른다.
> 4. 다음 저점을 잡는다.
>    1. limit_line 을 1부터 시작해서 저점이 하나라도 생길때까지 감소시킨다.
> 5. 다음 저점 이전으로 자른다.
>    1. 첫저점 예측의 가장 최근 데이터까지 자른다.
> 6. 위 과정을 다음 저점이 잡히지 않을때까지 반복한다.
> 7. 그래프를 그려본다.
> 8. 다른 코인들도 그려본다.
>
> ---
...
>
> * 첫 저점 잡는 함수
> * 잡은 저점의 가장 마지막 데이터 이전으로 자르는 함수
> * 생성한 저점으로 그래프를 그려주는 함수
