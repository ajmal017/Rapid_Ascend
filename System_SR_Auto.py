...
class TradeThread(QThread):
    ...
    def run(self):
        ...
        var_list = ['코인', '매수가', '매도가', '손절가']
        for i, var in enumerate([self.thread_parent.Coin, self.thread_parent.limit_buy_price, self.thread_parent.limit_sell_price, self.thread_parent.limit_exit_price]):
            if var is None:
        ...
        #                    매수 체결                     #
            ...
            while True:
                ...
                try:
                    ...
                    self.thread_parent.lineEdit_status.setText("%s %s 매도 등록" % (self.thread_parent.Coin, self.thread_parent.limit_sell_price))
                    break
                    ...
                    if sell_switch == 1:
                        ...
                        if CancelOrder is False:  # 남아있는 매도 주문이 없다. 취소되었거나 체결완료.
                            ...
                            if bithumb.get_order_completed(SellOrder)['data']['order_status'] != 'Cancel':
                                ...
                                self.thread_parent.profits *= (bithumb.get_balance(self.thread_parent.Coin)[2] - (
                        ...
                        if exit_count != -1:
                            ...
                            SellOrder = ('ask', self.Coin, SellOrder, 'KRW')
